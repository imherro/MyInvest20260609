...
def _theme_research_snapshot(snapshot_id: str) -> dict[str, Any]:
    ...
    return {
        ...
        "conflicts": [],
        "executive_summary": "Manual imported theme research records a theme state without security drill-down.",
        "key_facts": ["Theme state and leading indicators are research-layer outputs."],
        ...
        "payload": {
            "theme_id": "manual_import_mainline",
            "theme_name": "人工导入主线",
            "sector": "manual_review",
            "theme_state": "emerging",
            "signal_type": ["momentum", "structural"],
            "leading_indicators": ["manual breadth review"],
            "strength_score": 62,
        },
    }
